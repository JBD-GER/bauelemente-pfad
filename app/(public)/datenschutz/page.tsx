...
export const metadata: Metadata = {
  title: "Datenschutz – Bauelemente Pfad",
  description:
    "Datenschutzerklärung der Bauelemente Pfad UG (haftungsbeschränkt) – Hosting (Vercel), Datenverarbeitung (Supabase) sowie einwilligungsbasiertes Tracking (Google Tag Manager/GA4) inkl. Consent Mode v2 (sofern eingesetzt).",
...
const T = {
  ...
  intro: (
    <>
      ...
      <span className="font-semibold text-slate-900">{COMPANY.brand}</span> (betrieben durch{" "}
      <span className="font-semibold text-slate-900">{COMPANY.legal}</span>) personenbezogene Daten verarbeitet – inkl.
      Hosting über <span className="font-semibold text-slate-900">Vercel</span>, Datenverarbeitung über{" "}
      <span className="font-semibold text-slate-900">Supabase</span> sowie Tracking über{" "}
      <span className="font-semibold text-slate-900">Google Tag Manager</span> (Web + Server-Side) &amp;{" "}
      <span className="font-semibold text-slate-900">Google Analytics (GA4)</span> – inkl.{" "}
      <span className="font-semibold text-slate-900">Consent Mode v2</span>, sofern eingesetzt.
    </>
  ),
  ...
  sst: "9. Server-Side Tracking & Consent Mode v2",
  ga: "10. Google Analytics (GA4) & Conversion Tracking",
  thirdCountry: "11. Drittlandübermittlung",
  retention: "12. Speicherdauer",
  rights: "13. Ihre Rechte",
  objection: "14. Widerspruch & Widerruf",
  updates: "15. Änderungen dieser Erklärung",
  ...
  vTracking: "Google Tag Manager (Web + Server-Side) & Google Analytics (GA4) (sofern eingesetzt)",
  vConsent: "Consent Mode v2 i. d. R. nur nach Einwilligung (CMP/Consent-Banner)",

  importantTitle: "Wichtig",
  importantText:
    "Wir konfigurieren Tracking/Conversion-Tracking grundsätzlich so, dass es erst nach Ihrer Einwilligung aktiviert wird (sofern technisch eingerichtet). Ohne Einwilligung erfolgt nur technisch notwendige Verarbeitung (z. B. Server-Logs).",
  ...
  dataTypesList: [
    ...
    {
      b: "Projekt-/Anfragedaten",
      t: "(z. B. Ort/Adresse, Projektart, Details) zur Angebotserstellung und Kommunikation.",
    },
  ],

  legalBasisList: [
    { b: "Art. 6 Abs. 1 lit. b DSGVO", t: "Vertragsdurchführung/Anbahnung (z. B. Angebotsanfrage, Projektabstimmung)." },
  ...
  supabaseP1:
    "Sofern für Funktionen (z. B. Formularverarbeitung/Automatisierung) eingesetzt, nutzen wir Supabase. Dabei können je nach Nutzung u. a. technische Metadaten sowie Inhalte/Daten in einer Datenbank verarbeitet werden.",
  supabaseP2:
    "Zweck: Datenhaltung, sichere Verarbeitung von Anfragen/Workflows, ggf. Datei-/Link-Referenzen. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO (vertragliche/vorvertragliche Maßnahmen) bzw. Art. 6 Abs. 1 lit. f DSGVO (Betrieb/Sicherheit).",
  ...
  sstP1:
    "Wir setzen – sofern aktiviert – Server-Side Tracking ein. Dabei werden Tracking-Anfragen zunächst an einen von uns betriebenen (First-Party) Server-Endpoint übermittelt (z. B. im Rahmen von Google Tag Manager Server-Side). Von dort können die Daten – abhängig von Ihrer Einwilligung – an Empfänger wie Google (z. B. Google Analytics/Google Ads) weitergeleitet werden.",
  sstP2:
    "Zwecke: stabilere Messung (z. B. bei Browser-Restriktionen), Betrugs-/Missbrauchsabwehr, Steuerung/Minimierung von Datenflüssen sowie eine einwilligungsbasierte Ausspielung von Tags. Rechtsgrundlage: Art. 6 Abs. 1 lit. a DSGVO (Einwilligung) für Analyse/Marketing; Art. 6 Abs. 1 lit. f DSGVO für technisch notwendige Sicherheits-/Betriebszwecke (z. B. Abuse-Prevention).",
  sstList: [
    "Consent Mode v2: Wir übermitteln Einwilligungssignale (u. a. analytics_storage, ad_storage, ad_user_data, ad_personalization), damit Tags Ihre Auswahl respektieren (sofern eingesetzt).",
    "Ohne Einwilligung werden Analyse-/Marketing-Tags nicht ausgeführt bzw. nur in einer technisch eingeschränkten Form (abhängig von Konfiguration).",
    "Bei Server-Side Verarbeitung können technische Metadaten (z. B. IP-Adresse, User-Agent, Zeitstempel, Request-Header) zur Auslieferung, Sicherheit und Fehleranalyse verarbeitet werden.",
  ],

  gaP1:
    "Wir verwenden – sofern eingesetzt – Google Analytics (GA4), um die Nutzung unserer Website zu analysieren und Conversions zu messen (z. B. „Kontakt gesendet“). Dabei werden Ereignisse (Events) erfasst und ausgewertet.",
  gaP2:
  ...
  thirdCountryP1:
    "Bei der Nutzung von Diensten wie Google kann eine Verarbeitung von Daten in Drittländern (z. B. USA) nicht ausgeschlossen werden. Wir stützen eine Übermittlung – soweit erforderlich – auf geeignete Garantien (z. B. Standardvertragsklauseln und/oder anwendbare Zertifizierungsmechanismen).",

  retentionP1:
    "Wir speichern personenbezogene Daten nur so lange, wie es für die jeweiligen Zwecke erforderlich ist oder gesetzliche Aufbewahrungspflichten bestehen. Kontakt- und Angebotsanfragen werden regelmäßig gelöscht, sobald sie abschließend bearbeitet sind, sofern keine gesetzlichen Pflichten entgegenstehen.",
...
const TOC = [
  ...
  { id: "servertracking", t: "9. Server-Side Tracking & Consent Mode v2" },
  { id: "ga", t: "10. Google Analytics (GA4) & Conversion Tracking" },
  { id: "drittland", t: "11. Drittlandübermittlung" },
  { id: "speicher", t: "12. Speicherdauer" },
  { id: "rechte", t: "13. Ihre Rechte" },
  { id: "widerspruch", t: "14. Widerspruch & Widerruf" },
  { id: "updates", t: "15. Änderungen dieser Erklärung" },
] as const;
    ...
    <main className="relative overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-60 [mask-image:radial-gradient(ellipse_at_center,black_35%,transparent_70%)]">
          <div className="bp-ds-sheen absolute -left-1/2 top-0 h-full w-[200%]" />
        </div>
      </div>
            ...
            <div className="space-y-6">
              <div className="relative overflow-hidden rounded-[1.8rem] border border-slate-900/10 bg-white/70 p-6 shadow-[0_22px_80px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:p-8">
                <div className="pointer-events-none absolute inset-0 opacity-60">
                  <div className="bp-ds-card-sheen absolute -left-1/2 top-0 h-full w-[200%]" />
                </div>
                ...
                <div className="relative space-y-10">
                  ...
                  <Section id="verantwortlicher" title={T.responsible}>
                    <div className="rounded-2xl border border-slate-900/10 bg-white/70 p-4 shadow-sm">
                      ...
                      <div className="mt-2 grid gap-2 text-[12px] text-slate-700 sm:grid-cols-2">
                        <div>
                          Geschäftsführer: <span className="font-medium text-slate-900">{COMPANY.managingDirector}</span>
                        </div>
                        <div>
                          E-Mail:{" "}
                          <a className="font-medium text-slate-900 underline underline-offset-2" href={mailHref}>
                  ...
                  <Section id="servertracking" title={T.sst}>
                    <p>{T.sstP1}</p>
                    <p>{T.sstP2}</p>
                    <ul className="space-y-2">
                      {T.sstList.map((x) => (
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <Link
                      href="/kontakt"
                      className={cn(
                        "inline-flex h-12 w-full items-center justify-center rounded-2xl bg-slate-900 px-6 text-sm font-semibold text-white",
                        "shadow-[0_18px_55px_rgba(15,23,42,0.22)] transition hover:translate-y-[-1px] hover:bg-slate-800",
              ...
              <div className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-28 sm:h-32">
                <div className="absolute inset-0 bp-ds-bottom-fade" />
              </div>
            </div>
          </div>
        </div>
      ...
      <style>{`
        ...
        .bp-ds-sheen{
          ...
          animation: bpDsSheen 10s ease-in-out infinite;
          filter: blur(0.5px);
        ...
        .bp-ds-card-sheen{
          ...
          transform: translateX(-35%);
          animation: bpDsCardSheen 9s ease-in-out infinite;
          filter: blur(0.5px);
          will-change: transform, opacity;
        }
        @keyframes bpDsCardSheen{
